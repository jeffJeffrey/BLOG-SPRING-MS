...
export default function Home() {
  ...
  const featuredStories = [
    ...
    },
    {
      ...
      description:
        "Un voyage à travers les esprits les plus créatifs du monde.",
      image:
        ...
        <section className="flex-grow max-w-screen-xl mx-auto px-6 sm:px-12 py-16 w-full">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              ...
              >
                <FaFilter className="absolute left-4 top-1/2 transform -translate-y-1/2 text-green-600" />
                <select
                  value={selectedCategory}
                  onChange={(e) => setSelectedCategory(e.target.value)}
                  className="w-full pl-12 pr-4 py-3 rounded-lg bg-white text-gray-900 border border-green-600 focus:outline-none focus:ring-2 focus:ring-green-600 shadow-sm text-base appearance-none"
                >
